...
//Read access token from the component
$cominstaparams = JComponentHelper::getParams('com_instagallery');
$accessToken = $cominstaparams->get('access_token');
$authUserID = $cominstaparams->get('authorized_userid');
